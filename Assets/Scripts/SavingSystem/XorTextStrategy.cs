...
namespace SyntaxSultan.SavingSystem
{
    [CreateAssetMenu(menuName = "PSSGame/SavingStrategies/XorText", fileName ="XorTextStrategy")]
    public class XorTextStrategy : SavingStrategy
    {
        [Header("Use Context Menu to generate a random key.")]
        [SerializeField] string key = "MyUltraSecureKey";
